		...
		<div class="tie-builder-content-area tie-popup-block tie-popup-window">
			...
			echo '<div class="advanced-block-settings block-settings">';
				...
				tie_page_builder_option(
					...
					array(
						'name'  => esc_html__( 'Disable Gradiant Overlay', TIELABS_TEXTDOMAIN ),
						'id'    => 'gradiant_overlay',
...
function tie_add_page_builder(){
	...
	$sections       = false;
	$builder_style  = '';
	$inactive_text  = $button_text = esc_html__( 'Use the TieLabs Builder', TIELABS_TEXTDOMAIN );
	$active_text    =  esc_html__( 'Use the Default Editor', TIELABS_TEXTDOMAIN );
