				...
				if( is_array( $twitter_data ) ){
					...
					if( ! empty( $instance['slider'] ) ){ ?>
						<div class="slider-links">
							<ul class="tie-slider-nav"></ul><a href="https://twitter.com/<?php echo esc_attr( $twitter_username )  ?>" target="_blank" rel="nofollow" class="button"><?php esc_html_e( 'Follow Us', TIELABS_TEXTDOMAIN ) ?></a>
						</div>
						...
						<a href="https://twitter.com/<?php echo esc_attr( $twitter_username ) ?>" target="_blank" rel="nofollow" class="button dark-btn fullwidth"><?php esc_html_e( 'Follow us on Twitter', TIELABS_TEXTDOMAIN ) ?></a>
						<?php
					}
				}
			}
